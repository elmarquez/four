...
const ClickSelectionController = (function () {
    ...
    ClickSelectionController.prototype.onKeyDown = function (event) {
        if (event.keyCode === KEY.ALT || event.keyCode === KEY.CTRL || event.keyCode === KEY.SHIFT) {
    ...
    ClickSelectionController.prototype.onSingleClick = function () {
        ...
        if (selection) {
            ...
            if (this.modifiers[KEY.SHIFT] === true) {
                this.dispatchEvent({type: 'add', selection: selection});
            } else if (this.modifiers[KEY.ALT] === true) {
...
export default ClickSelectionController;