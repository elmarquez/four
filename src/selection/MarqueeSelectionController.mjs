...
const MarqueeSelectionController = (function () {
    ...
    MarqueeSelectionController.prototype.enable = function () {
        ...
        addListener(self.camera, EVENT.UPDATE, self.onCameraUpdate);
        addListener(self.viewport, EVENT.CAMERA_CHANGE, self.onCameraChange);
    ...
    MarqueeSelectionController.prototype.select = function (x, y, width, height) {
        ...
        this.selection = this.index.viewIndex.colliding({
            ...
            return utils.isContained(r1, r2);
        });
