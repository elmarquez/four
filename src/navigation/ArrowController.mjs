    ...
    ArrowController.prototype.onKeyDown = function (event) {
        ...
        switch (event.keyCode) {
            ...
            case this.KEY.MOVE_TO_EYE_HEIGHT:
                this.setWalkHeight();
                this.dispatchEvent({
                    type: EVENT.CONTINUOUS_UPDATE_START,
                    id: 'move',
            ...
            case this.KEY.MOVE_BACK:
                if (!this.move.backward) {
                    ...
                    this.dispatchEvent({type: EVENT.CONTINUOUS_UPDATE_START, id: 'move', task: 'arrow-move-back'});
                    return false;
                }
                break;
            case this.KEY.MOVE_LEFT:
                if (!this.move.left) {
                    this.move.left = true;
                    this.dispatchEvent({type: EVENT.CONTINUOUS_UPDATE_START, id: 'move', task: 'arrow-move-left'});
                }
                break;
            ...
            case this.KEY.MOVE_UP:
                if (!this.move.up) {
                    this.move.up = true;
                    this.dispatchEvent({type: EVENT.CONTINUOUS_UPDATE_START, id: 'move', task: 'arrow-move-up'});
                }
                break;
        ...
        switch (event.keyCode) {
            ...
            case this.KEY.MOVE_FORWARD:
                if (this.move.forward) {
                    ...
                    this.dispatchEvent({type: EVENT.CONTINUOUS_UPDATE_END, id: 'move'});
                    return false;
                }
                break;
            case this.KEY.MOVE_BACK:
