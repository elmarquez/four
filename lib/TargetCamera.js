...
FOUR.TargetCamera = (function () {
    ...
    TargetCamera.prototype.setPositionAndTarget = function (x, y, z, tx ,ty, tz) {
        var self = this;
        self.target.set(tx, ty, tz);
        self.distance = distance(self.position, self.target);
        self.planner.tweenToPosition(self, x, y, z, tx, ty, tz, null, null, null, self.emit.bind(self));
    };
