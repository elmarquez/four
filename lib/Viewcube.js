...
FOUR.Viewcube = (function () {
    ...
    Viewcube.prototype.makeCubeCorners = function () {};

    Viewcube.prototype.makeCubeEdges = function () {};

    Viewcube.prototype.makeCubeFaces = function () {};
    ...
    Viewcube.prototype.setupGeometry = function () {
        ...
        if (self.display.cube) {
            ...
            var frontFace  = self.makeFace(self.FACES.FRONT, 70,   0, -50,   0, [{axis:X_AXIS, rad:ROTATE_90}]);
            var rightFace  = self.makeFace(self.FACES.RIGHT,  70,  50,   0,   0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_90}]);
            var backFace   = self.makeFace(self.FACES.BACK,    70,   0,  50,   0, [{axis:X_AXIS, rad:ROTATE_270}]);
            var leftFace   = self.makeFace(self.FACES.LEFT,   70, -50,   0,   0, [{axis:Y_AXIS, rad:ROTATE_270},{axis:Z_AXIS, rad:ROTATE_90}]);
    ...
    Viewcube.prototype.setView = function (view) {
        ...
        switch (view) {
            ...
            case self.FACES.BOTTOM_BACK_EDGE:
                self.tweenViewRotation(0,-Math.PI / 4, Math.PI);
                break;
            case self.FACES.BOTTOM_BACK_LEFT_CORNER:
                self.tweenViewRotation(0, -Math.PI / 4, Math.PI * 0.75);
                break;
            case self.FACES.BOTTOM_BACK_RIGHT_CORNER:
                self.tweenViewRotation(0, -Math.PI / 4, Math.PI * 1.25);
                break;
            ...
            case self.FACES.BOTTOM_FRONT_RIGHT_CORNER:
                self.tweenViewRotation(0, -Math.PI / 4, Math.PI * 1.75);
                break;
            case self.FACES.BOTTOM_LEFT_EDGE:
                self.tweenViewRotation(0,-Math.PI / 4, Math.PI * 0.5);
                break;
            ...
            case self.FACES.TOP_FRONT_EDGE:
                self.tweenViewRotation(0, Math.PI / 4,0);
                break;
            ...
            case self.FACES.TOP_LEFT_EDGE:
                self.tweenViewRotation(0, Math.PI / 4, -Math.PI * 1.5);
                break;
