...
FOUR.Viewcube = (function () {
    ...
    function Viewcube (config) {
        ...
        setTimeout(function () {
            //self.view.quaternion.copy(self.viewport.camera.quaternion.inverse());
            self.onMouseLeave();
        },1);
    }
    ...
    Viewcube.prototype.updateOrientation = function () {
        ...
        //self.control.quaternion.copy(self.viewport.camera.quaternion);
        //self.control.quaternion.copy(self.viewport.camera.quaternion.conjugate());
        //self.control.quaternion.copy(self.viewport.camera.quaternion.inverse());
        //self.control.quaternion.copy(self.viewport.camera.quaternion.inverse().conjugate());

        //self.view.quaternion.copy(self.viewport.camera.quaternion);
        //self.view.quaternion.copy(self.viewport.camera.quaternion.inverse().conjugate());
        //self.view.quaternion.copy(self.viewport.camera.quaternion.inverse());
        self.view.quaternion.copy(self.viewport.camera.quaternion.conjugate());
