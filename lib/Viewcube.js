...
FOUR.Viewcube = (function () {
    ...
    function Viewcube (config) {
        ...
        self.FACES = {
            ...
            TOP_FRONT_EDGE: 6, // yes
            TOP_RIGHT_EDGE: 7,
            TOP_BACK_EDGE: 8,
            TOP_LEFT_EDGE: 9,

            FRONT_RIGHT_EDGE: 10, // yes
            BACK_RIGHT_EDGE: 11,
            BACK_LEFT_EDGE: 12,
            FRONT_LEFT_EDGE: 13, // yes

            BOTTOM_FRONT_EDGE: 14, // yes
    ...
    Viewcube.prototype.setupGeometry = function () {
        ...
        if (self.display.cube) {
            ...
            var backFace   = self.makeFace(self.FACES.BACK,   70, -50,   0,   0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Z_AXIS, rad:ROTATE_180}], self.FACE_COLOUR);
    ...
    Viewcube.prototype.setView = function (view) {
        ...
        switch (view) {
            ...
            case self.FACES.TOP_FRONT_LEFT_CORNER:
                self.tweenControlRotation(Math.PI / 4, Math.PI / 4, Math.PI / 4);
                break;
