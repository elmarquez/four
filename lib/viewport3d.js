...
var Viewport3D = (function () {
    ...
    Viewport3D.prototype.setupControllers = function () {
        ...
        self.controller.selection = new SelectionControl({viewport: self});
    ...
    Viewport3D.prototype.setupSelection = function () {
        ...
        // mouse events
        self.domElement.addEventListener('mousedown', self.controller.selection.onMouseDown.bind(self), false);
        self.domElement.addEventListener('mouseover', self.controller.selection.onMouseOver.bind(self), false);
        self.domElement.addEventListener('mouseup', self.controller.selection.onMouseUp.bind(self), false);
        // update the scene bounding box when the selection set changes
        self.controller.selection.addEventListener('update', function () {
            self.boundingBox.update(self.controller.selection.getObjects());
        });
    };
