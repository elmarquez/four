...
Viewport3D.prototype.setupKeyboardBindings = function () {
    ...
    Mousetrap.bind('w', function () { self.setMode(self.MODES.TRACKBALL); });
    Mousetrap.bind('e', function () { self.setMode(self.MODES.WALK); });
    Mousetrap.bind('r', function () { self.setMode(self.MODES.ORBIT); });

    Mousetrap.bind('f', function () { self.zoomToFit(); });
...
Viewport3D.prototype.zoomIn = function () {
    console.log('zoom in');
};
