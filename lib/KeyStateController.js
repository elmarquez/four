...
FOUR.KeyStateController = (function () {
  ...
  function KeyStateController (config) {
    ...
    // arrow keys
    Mousetrap.bind('up', function () { self.keyup(self.KEYS.UP); });
    Mousetrap.bind('down', function () { self.keyup(self.KEYS.DOWN); });
    Mousetrap.bind('left', function () { self.keyup(self.KEYS.LEFT); });
    Mousetrap.bind('right', function () { self.keyup(self.KEYS.RIGHT); });
  }
